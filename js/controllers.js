...
.controller('propertyhomeCtrl', function ($scope, $http, $state, $stateParams, $timeout, ionicMaterialMotion, ionicMaterialInk, filterModal, localStorageService, $ionicLoading, $ionicPopup) {
    ...
    function divFunction() {
        ...
        $(".clicks").click(function () {
            ...
            localStorageService.set('PropertyId', propertyId);
            var proData = JSON.parse(localStorage.getItem('FilterResult'));
            for (var i = 0; i < proData.length;i++){
                if (proData[i].productid == propertyId) {
                    localStorageService.set('propertyFave', proData[i]);
                    break;
                }
            }
            $ionicLoading.show({
...
.controller('EntranceCtrl', function ($scope, $state, $ionicHistory,$ionicPopup, localStorageService) {
    ...
    if ($scope.contactImage == null || $scope.contactImage == "null"){
        $scope.contactImage = localStorage.getItem('contactImage');
        if ($scope.contactImage == null || $scope.contactImage == "null")
            $scope.contactImage = "";
    }
    else if ($scope.contactImage == "")
        $scope.contactImage = "";
